...
# model_temp = tf.keras.applications.ResNet50V2(
#     include_top=True,
#     weights="imagenet",
...
with open("./caption_model_weights/word_to_idx.pkl", "rb") as w2i:
    word_to_idx = pickle.load(w2i)

with open("./caption_model_weights/idx_to_word.pkl", "rb") as i2w:
